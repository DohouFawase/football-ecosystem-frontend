...
export const Navbar = () => {
  ...
  const handleLogout = () => {
    // dispatch(logout()) ← ton action Redux logout ici
          ...
          <div className="hidden md:flex items-center gap-4">
            {isLoggedIn && user ? (
              <div className="relative">
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-xl border border-gray-100 py-2 animate-in fade-in zoom-in-95 duration-100">
                    ...
                    <Link href="/dashboard" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                      <Icons.Dashboard /> Dashboard
                    </Link>
                    <Link href="/profile" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                      <Icons.User /> My Profile
                    </Link>
                    <Link href="/settings" className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
              ...
              <div className="flex gap-2">
                <Button variant="ghost" className="font-bold text-slate-600" onClick={() => openAuth("login")}>
                  Login
                </Button>
                <Button className="bg-blue-600" onClick={() => openAuth("register")}>
                  Get Started
                </Button>
              </div>
            )}
