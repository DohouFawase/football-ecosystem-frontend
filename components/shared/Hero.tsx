...
export const Hero = () => {
  ...
  // Nom affiché : firstName ou email comme fallback
  const displayName = user?.firstName || user?.email?.split("@")[0] || "User";

  return (
    <section className="relative bg-white pt-24 pb-32 overflow-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] -right-[10%] w-125 h-125 bg-blue-50 rounded-full blur-3xl opacity-50" />
        <div className="absolute top-[20%] -left-[5%] w-75 h-75 bg-slate-100 rounded-full blur-2xl opacity-40" />
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-slate-100">
                {[
                  ...
                  >
                    <div className={`mb-5 transform group-hover:scale-110 transition-transform ${item.color}`}>
                      {item.icon}
                    </div>
              ...
              <div className="max-w-5xl space-y-8">
                <h1 className="text-6xl md:text-8xl font-bold text-slate-900 tracking-tighter leading-[0.95]">
                  ...
                  <span className="relative inline-block">
                    Data.
                    <span className="absolute bottom-2 left-0 w-full h-3 bg-blue-600/10 -z-10" />
                  </span>
                </h1>
                <p className="text-2xl text-slate-500 max-w-3xl font-normal leading-relaxed">
                  ...
                  talent discovery across the continent. Simple. Powerful. Global.
                </p>
              </div>
            </div>
