  ...
  <div className="space-y-12">
    ...
    <div className="space-y-6">
      <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tighter leading-[1.1]">
        Drive your <br /> 
        <span className="text-blue-600 underline decoration-slate-200 underline-offset-8">organization.</span>
      </h1>
      <p className="text-xl text-slate-500 max-w-2xl leading-relaxed font-medium">
        Welcome to your control tower. Manage your competitions, centralize your talent pool, and deploy your global scouting network.
      </p>
    </div>
    ...
    <div className="flex flex-wrap gap-4 pt-4">
      ...
      >
        <svg className="mr-2 group-hover:rotate-90 transition-transform" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 5v14M5 12h14"/></svg>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12 border-t border-slate-100">
      {[
        { 
          ...
          icon: <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M4 22h16M10 14.66V17M14 14.66V17M18 9.22V14.66a6 6 0 0 1-12 0V9.22c0-1.5 1-3.22 3-3.22h6c2 0 3 1.72 3 3.22Z"/></svg>,
          color: "text-amber-500"
        },
        { 
          title: "Talent Database", 
          desc: "Access the list of certified players.", 
          icon: <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>,
          color: "text-blue-600"
        },
        { 
          title: "Scouting Network", 
          desc: "Connect with certified FIFA agents.", 
          icon: <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><path d="m16 12-4-4-4 4M12 8v8"/></svg>,
          color: "text-emerald-600"
        }
      ].map((item, i) => (
        <div key={i} className="group p-8 rounded-[2.5rem] bg-slate-50 border border-transparent hover:border-slate-200 hover:bg-white hover:shadow-2xl transition-all cursor-pointer">
          <div className={`mb-5 transform group-hover:scale-110 transition-transform ${item.color}`}>{item.icon}</div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-left-10 duration-1000">
              ...
              <div className="max-w-5xl space-y-8">
                ...
                <p className="text-2xl text-slate-500 max-w-3xl font-normal leading-relaxed">
                  The most advanced digital platform for leagues, clubs, and talent discovery across the continent. Simple. Powerful. Global.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-16 w-full pt-20 border-t border-slate-100 animate-in fade-in duration-1000 delay-500 fill-mode-both">
               {[
                 ...
                 <div key={i} className="hover:translate-x-1 transition-transform cursor-default">
                   ...
                   <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-2 border-l-2 border-blue-600 pl-3">{stat.label}</p>
                 </div>
               ))}
            </div>
          </div>
